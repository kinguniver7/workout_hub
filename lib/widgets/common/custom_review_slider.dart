...
import 'package:workout_hub/widgets/common/arc_chooser.dart';
import 'package:workout_hub/widgets/painters/SmilePainter.dart';

class CustomReviewSlider extends StatefulWidget {
  CustomReviewSlider({Key key}) : super(key: key);

  @override
  _CustomReviewSliderState createState() => new _CustomReviewSliderState();
}

class _CustomReviewSliderState extends State<CustomReviewSlider>
